...
import 'package:part1/part1.dart' as _i6;
...
/// A class which mocks [MyReadLine].
///
/// See the documentation for Mockito's code generation for more information.
class MockMyReadLine extends _i1.Mock implements _i6.MyReadLine {
  MockMyReadLine() {
    _i1.throwOnMissingStub(this);
  }

  @override
  int get choice => (super.noSuchMethod(
        Invocation.getter(#choice),
        returnValue: 0,
      ) as int);
  @override
  bool readChoiceInt() => (super.noSuchMethod(
        Invocation.method(
          #readChoiceInt,
          [],
        ),
